//
//  SRouterStub+UIViewController.swift
//  SwiftStubRouter
//
...
func stubRouteToControllerInit(_ moduleName: String, symbol: String) -> UnsafeRawPointer? {
...
private func stubRouteToSymbolTable(_ symbol: String,
    ...
    for i in 0..<symtabCmd.pointee.nsyms {
        ...
        if swift_demangle(_curSymbolStr) == symbol {
